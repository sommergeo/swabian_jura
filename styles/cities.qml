...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" maxScale="0" styleCategories="AllStyleCategories" version="3.8.2-Zanzibar" readOnly="0" minScale="1e+08" labelsEnabled="1">
  ...
  <labeling type="simple">
    <settings>
      <text-style multilineHeight="1" fontLetterSpacing="0" previewBkgrdColor="#ffffff" fontStrikeout="0" isExpression="0" textColor="0,0,0,255" fontSizeUnit="Point" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" fontItalic="0" fontWeight="50" textOpacity="1" useSubstitutions="0" fieldName="Name" fontCapitals="0" fontFamily="Franklin Gothic Medium" fontWordSpacing="0" namedStyle="Standard" fontSize="14">
      ...
      <text-format leftDirectionSymbol="&lt;" autoWrapLength="0" useMaxLineLengthForAutoWrap="1" addDirectionSymbol="0" multilineAlign="3" rightDirectionSymbol=">" reverseDirectionSymbol="0" decimals="3" formatNumbers="0" wrapChar="" placeDirectionSymbol="0" plussign="0"/>
      <placement dist="3" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" rotationAngle="0" offsetUnits="MM" repeatDistanceUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" centroidWhole="0" geometryGeneratorEnabled="0" placementFlags="10" quadOffset="4" offsetType="0" xOffset="0" maxCurvedCharAngleIn="25" fitInPolygonOnly="0" yOffset="0" distUnits="MM" priority="8" geometryGenerator="" geometryGeneratorType="PointGeometry" centroidInside="0" repeatDistance="0" placement="0"/>
      <rendering scaleVisibility="0" scaleMax="0" limitNumLabels="0" labelPerPart="0" obstacleType="0" mergeLines="0" drawLabels="1" maxNumLabels="2000" zIndex="0" fontMinPixelSize="3" displayAll="0" fontLimitPixelSize="0" fontMaxPixelSize="10000" obstacleFactor="1.58" minFeatureSize="0" scaleMin="0" upsidedownLabels="0" obstacle="1"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option name="properties"/>
