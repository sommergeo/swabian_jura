    ...
    <rasterrenderer opacity="1" alphaBand="-1" classificationMax="1400" classificationMin="200" type="singlebandpseudocolor" band="1">
      ...
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" clip="0" classificationMode="2">
          ...
          <item label="200" color="#80ecb2" value="200" alpha="255"/>
          <item label="400" color="#dafebf" value="400" alpha="255"/>
          <item label="600" color="#ffffcd" value="600" alpha="255"/>
          <item label="800" color="#fee6ac" value="800" alpha="255"/>
          <item label="1000" color="#f5d6bd" value="1000" alpha="255"/>
          <item label="1200" color="#ede3dc" value="1200" alpha="255"/>
